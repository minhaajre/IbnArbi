...
export const MANSION_GUIDANCE: Record<number, MansionGuidance> = {
  ...
  12: {
    ...
    energy: 'ending',
    cycleRole: 'differentiating',
    cycleRoleArabic: 'تمييز',
  ...
  17: {
    ...
    energy: 'stabilizing',
    cycleRole: 'separating',
    cycleRoleArabic: 'تفريق',
...
export const CYCLE_ROLE_COLORS: Record<string, { bg: string; text: string; border: string; label: string; labelArabic: string; tooltip: string; tooltipArabic: string; tooltipBody: string }> = {
  ...
  'separating': {
    ...
    tooltipArabic: 'تفريق',
    tooltipBody: 'Time of release and completion. Forms loosen and cycles conclude. This phase supports letting go and preparing for renewal.'
  }
};
